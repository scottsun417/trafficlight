...
if __name__ == '__main__':
    res_dir = r'D:\workspace\task\ModelArts\modelArts-task\competition\SODIC\garbage_classify\debug\batch_infer_results'  # 模型预测结果
    gt_dir = r'D:\workspace\task\ModelArts\modelArts-task\competition\SODIC\garbage_classify\datasets\垃圾分类标注完成\第一批_release\trainval\VOC2007\Annotations'  # groud_truth
    class_path = os.path.join(r'D:\workspace\task\ModelArts\modelArts-task\competition\SODIC\garbage_classify\datasets\垃圾分类标注完成\第一批_release\trainval', 'train_classes.txt')  # 数据集所有类别名的文件
    imagesetfile = os.path.join(gt_dir, '../ImageSets/Main/trainval.txt')  # 读取图像名字列表文件

    # res_dir = r'D:\workspace\task\ModelArts\modelArts-task\case_dev\mask_detect\datasets\huawei\test\20200203\batch_infer_results'  # 模型预测结果
    # gt_dir = r'D:\workspace\task\ModelArts\modelArts-task\case_dev\mask_detect\datasets\huawei\test\20200203\Annotations'  # groud_truth
    # class_path = os.path.join(
    #     r'D:\workspace\task\ModelArts\modelArts-task\case_dev\mask_detect\datasets\huawei\test\20200203',
    #     'train_classes.txt')  # 数据集所有类别名的文件
    # imagesetfile = os.path.join(gt_dir, '../ImageSets/Main/test.txt')  # 读取图像名字列表文件
